...
export const WhatWeOffer = () => {
  ...
  return (
    <>
      ...
      <div class="my-8 w-full border-t border-red-600">
        <div class="w-[fit-content] bg-red-600 px-4 py-2 uppercase text-white">
          The beasts
        </div>
      </div>
      ...
      <div class="flex justify-between text-center">
        <div class="p-8">
          <div class="mx-auto w-[fit-content] bg-red-600 px-4 py-2 uppercase text-white">
            Half day
          </div>
          <div>
            <p>- Guided tour</p>
